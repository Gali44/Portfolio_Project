...
class windows_10_chrome(unittest.TestCase):
    ...
    def test_icons_clickability(self):
        ...
        try:
            ...
            print("Check icons clickability")
    ...
    def test_first_screen_text(self):
        ...
        # assert full text
        self.assertEqual([first_line, second_line, third_line], ["CALIFORNIA MARKETING", "A Full-Stack Creative "
                                                                                         "Agency in CA",
    ...
    def test_lets_chat(self):
        ...
        assert "wrong" not in list_for_assertion
    ...
    def test_cart_shopping(self):
        ...
        print(fr2text)
        assert "We can't accept online orders right now" not in fr2text
    ...
    def test_event_reservation(self):
        ...
        assert driver.find_element(By.XPATH, "//h2[@data-hook='thank-you-message-title']").text == "Thank you! See you soon"
    ...
    def test_subscribe_form(self):
        ...
        assert driver.find_element(By.XPATH, "//span[@class='color_15'][contains(.,'Thanks for submitting!')]").is_displayed()
        print("The form was sent")

    def tearDown(self):
        self.driver.quit()

class windows_10_firefox(unittest.TestCase):

    # headless function, helper
    def setUp(self):
    ...
    def test_event_reservation(self):
        ...
        # click on 'RSVP' button
        time.sleep(3)
        wait.until(EC.element_to_be_clickable((By.XPATH, "(//button[@data-hook='rsvp-button'][contains(.,'RSVP')])[2]"))).click()
        time.sleep(3)
...
class windows_10_edge(unittest.TestCase):
